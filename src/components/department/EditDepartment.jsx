...
<span className="userUpdateTitle"><i className="fas fa-edit text-warning"/>&nbsp;&nbsp;Edit Department Information</span>
</h2>
...
<input type="text" placeholder="Finance" 
className="userUpdateInput" name="departEdit" id="departEdit"/>
